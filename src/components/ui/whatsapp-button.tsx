    ...
    >
      <div className="relative">
        ...
        <span className="absolute -top-0.5 -right-0.5 flex h-2.5 w-2.5 md:h-4 md:w-4">
          ...
          <span className="relative inline-flex rounded-full h-2.5 w-2.5 md:h-4 md:w-4 bg-white/20"></span>
        </span>
      </div>
      <span className="font-bold md:font-black uppercase tracking-wider md:tracking-widest text-[9px] md:text-[13px]">
        Intéressé(e)?
      </span>
      
      {/* Tooltip background pulse */}
      <div className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse -z-10 opacity-20 group-hover:scale-110 transition-transform" />
    </a>
  );
}
